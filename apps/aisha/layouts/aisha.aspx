        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo">
                        <h2>
                            <a href="http://laptrinh365.com/Pages/aisha.aspx">Lap trinh 365</a>
                        </h2>
                    </div>
                </div>
                <div class="col-sm-8">
                    ...
                    <div class="clients_say wow slideInUp">
                        ...
                        <div class="clients_say_list fix">
                            ...
                            <div class="c_img floatright">
                                <img src="/Style%20Library/apps/aisha/images/client.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="single_blog wow slideInUp" data-wow-duration="1s">
                        <img class="img-responsive" src="/Style%20Library/apps/aisha/images/1.jpg" alt="">
                ...
                <div class="col-sm-4">
                    <div class="single_blog wow slideInUp" data-wow-duration="2s">
                        <img class="img-responsive" src="/Style%20Library/apps/aisha/images/2.jpg" alt="">
                        <h2>Cache Invalidation StrategiesWith Varnish Cache</h2>
                        <div class="comment_area fix">
                            <div class="date floatleft">
                                <p><span><i class="fa fa-calendar-o"></i></span> March 4, 2014</p>
                ...
                <div class="col-sm-4">
                    <div class="single_blog wow slideInUp" data-wow-duration="3s">
                        <img class="img-responsive" src="/Style%20Library/apps/aisha/images/3.jpg" alt="">
                        <h2>Cache Invalidation StrategiesWith Varnish Cache</h2>
                        <div class="comment_area fix">
                            <div class="date floatleft">
                                <p><span><i class="fa fa-calendar-o"></i></span> March 4, 2014</p>
