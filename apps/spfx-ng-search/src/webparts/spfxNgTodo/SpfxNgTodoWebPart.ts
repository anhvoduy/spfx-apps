...
import styles from './SpfxNgTodo.module.scss';
import * as strings from 'spfxNgTodoStrings';
import { ISpfxNgTodoWebPartProps } from './ISpfxNgTodoWebPartProps';

import * as angular from 'angular';
import './app/app.module';

export default class SpfxNgTodoWebPart extends BaseClientSideWebPart<ISpfxNgTodoWebPartProps> {
  private $injector: angular.auto.IInjectorService;

  public render(): void {    
    if(this.renderedOnce === false) {
        this.domElement.innerHTML = `
          <div class="${styles.spfxNgTodoWebPart }">
      ...
      `;      
      this.$injector = angular.bootstrap(this.domElement, ['spfxNgTodo']);
    }
