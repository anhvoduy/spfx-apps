...
import { ISearchResults, ICells, ICellValue  } from './../models/ISearchResult';
...
export default class SearchController {
    public static $inject: string[] = ['SearchService', '$rootScope', '$scope', '$attrs'];
    ...
    constructor(
        ...
        $rootScope.$on('configurationChanged', (event: angular.IAngularEvent, args: IConfigurationChangeArgs): void => {
    ...
    public getSearchResults(): void{
        ...
        this.searching = true;
        this.searchService.getSearchResults(this._web, this._contentType)
